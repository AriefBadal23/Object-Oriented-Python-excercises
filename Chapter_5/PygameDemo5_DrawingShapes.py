...
while True:
    ...
    pygame.draw.circle(window, GREEN, (400, 50), 30, 2)  # 1 pixel edge
    ...
    # Draw an anti-aliased lines: a single line , the a list of points
    pygame.draw.aaline(window, RED, (500, 400), (540, 470), 1)
    pygame.draw.aalines(
        window, BLUE, True, ((580, 400), (587, 450), (595, 460), (600,400)), 1
    )
